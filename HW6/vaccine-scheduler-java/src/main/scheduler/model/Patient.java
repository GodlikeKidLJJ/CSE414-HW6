...
//        ConnectionManager cm = new ConnectionManager();  // use for connecting local(personal laptop) to online database
//        Connection con = cm.createConnection(); //executing Sql operations
//
